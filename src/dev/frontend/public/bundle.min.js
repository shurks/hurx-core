...
(() => {
  ...
  var _A = class _A extends Component {
    ...
    render() {
      return /* @__PURE__ */ VDOM.createNode(VDOM.createNode, null, /* @__PURE__ */ VDOM.createNode("div", { id: this.state.test, onClick: () => {
        this.state.test++;
      } }, this.state.test, /* @__PURE__ */ VDOM.createNode("div", null, "asasssaeastests"), /* @__PURE__ */ VDOM.createNode("div", null, "fessf"), /* @__PURE__ */ VDOM.createNode("div", null, "1ss"), /* @__PURE__ */ VDOM.createNode("div", null, "3"), /* @__PURE__ */ VDOM.createNode("div", null, "4"), /* @__PURE__ */ VDOM.createNode("div", null, "gga2b")), /* @__PURE__ */ VDOM.createNode("div", null, "Yoloa"), "Test");
    }
  };
  __name(_A, "A");
  var A = _A;
  new VDOM(
    "main",
    /* @__PURE__ */ VDOM.createNode("div", null, /* @__PURE__ */ VDOM.createNode("div", { style: "background: red; color: white; padding: 5px;" }, /* @__PURE__ */ VDOM.createNode("div", null, "Start of VDOM")), /* @__PURE__ */ VDOM.createNode("div", null, "Tessts"), /* @__PURE__ */ VDOM.createNode(VDOM.createNode, null, /* @__PURE__ */ VDOM.createNode("div", null, "TEST"), /* @__PURE__ */ VDOM.createNode("div", null, "TEST"), /* @__PURE__ */ VDOM.createNode("div", null, "TEST"), /* @__PURE__ */ VDOM.createNode("div", null, "TEST"), /* @__PURE__ */ VDOM.createNode(TestPage, null), /* @__PURE__ */ VDOM.createNode(Router, null, /* @__PURE__ */ VDOM.createNode("div", null, "Route tes12sst"), /* @__PURE__ */ VDOM.createNode("div", null, "Route tes12t"), /* @__PURE__ */ VDOM.createNode("div", null, "Route tes12t"), /* @__PURE__ */ VDOM.createNode("div", null, "Route tes12tss"), /* @__PURE__ */ VDOM.createNode("div", null, "Route tes12tss"), /* @__PURE__ */ VDOM.createNode(A, null), "test2", /* @__PURE__ */ VDOM.createNode(Route, { path: "/test" }, /* @__PURE__ */ VDOM.createNode(TestPage, null), /* @__PURE__ */ VDOM.createNode(TestPage, null)), /* @__PURE__ */ VDOM.createNode(Route, { path: "/test2" }, /* @__PURE__ */ VDOM.createNode(TestPage, null), /* @__PURE__ */ VDOM.createNode(TestPage, null), /* @__PURE__ */ VDOM.createNode(TestPage, null), /* @__PURE__ */ VDOM.createNode(TestPage, null)), /* @__PURE__ */ VDOM.createNode(Route, { path: "/" }, /* @__PURE__ */ VDOM.createNode(HomePage, null)), "test12345678")), /* @__PURE__ */ VDOM.createNode("div", { style: "background: maroon; color: white; padding: 5px;" }, /* @__PURE__ */ VDOM.createNode("div", null, "End of VDOM")))
  );
})();

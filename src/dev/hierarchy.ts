 ...
 */
export default class Hierarchy extends CLICommand<Dev> {
    public commands = []
    public command = new Command(this.parent, 'hierarchy', 'Generates a folder hierarchy of the package src folder')
        .event('start', async() => {
